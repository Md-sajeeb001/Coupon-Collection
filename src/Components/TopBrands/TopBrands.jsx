    ...
    <div className="py-10">
      <div>
        ...
        <p className="pb-10 text-slate-600 max-w-2xl mx-auto text-center">
          Go Into Brands Carefree and make astounding savings at Yellow,
          Texmart, RichMan , Artisan, lereve, Arong, Ecstasy, Cats Eye and
          others. Get your clothing , footwear, and everything availed online
          save biggest with promo codes, coupons, and discount offers.
        </p>
      </div>
